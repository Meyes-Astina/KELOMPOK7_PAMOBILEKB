...
class Model:
    ...
    def predict_from_image(self, image_file):
        '''
        Menggunakan preprocessing seperti resize, rescale, dan grayscale untuk
        model klasifikasi kematangan tomat.
        '''
        # Preprocessing: Convert to grayscale, resize, and normalize
        image = Image.open(image_file).convert('RGB')
        image = image.resize((150, 150))  # Sesuaikan dengan dimensi model
